<div class="card h-lg-100">
    <div class="card-body d-flex justify-content-between align-items-start flex-column">
      ...
      <div class="d-flex flex-column my-7">
        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">2150</span>
        <div class="m-0">
          <span class="fw-semibold fs-6 text-gray-400">Email Sent</span>
        </div>
      </div>
      <span class="fw-semibold fs-6 text-gray-400">This month</span>
    </div>
  </div>