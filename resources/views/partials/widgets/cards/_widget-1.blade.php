<div class="card h-lg-100">
	<div class="card-body d-flex justify-content-between align-items-start flex-column">
	  ...
	  <div class="d-flex flex-column my-7">
		<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">221</span>
		<div class="m-0">
		  <span class="fw-semibold fs-6 text-gray-400">Total Opened</span>
		</div>
	  </div>
	  <span class="fw-semibold fs-6 text-gray-400">Total sent <span class="fw-bolder fs-6 text-gray-800">1.3K</span>
	  </span>
	</div>
  </div>