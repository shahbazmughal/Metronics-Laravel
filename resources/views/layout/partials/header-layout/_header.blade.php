        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
            <a href="/">
                ...
                @if ($bodyAttribute === 'dark-header')
                    <img alt="Logo" src="{{ image('logos/logo_light.png') }}" class="h-20px h-lg-30px theme-light-show"/>
                @elseif($bodyAttribute === 'light-header')
                    <img alt="Logo" src="{{ image('logos/logo.png') }}" class="theme-light-show h-20px h-lg-30px theme-light-show"/>
                    <img alt="Logo" src="{{ image('logos/logo-light.png.png') }}" class="theme-dark-show h-20px h-lg-30px theme-light-show"/>
                @endif
            </a>
        </div>
        <!--end::Logo-->
