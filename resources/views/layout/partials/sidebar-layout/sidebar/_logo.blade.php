...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="/">
		...
		@if ($bodyAttribute === 'dark-sidebar')
			<img alt="Logo" src="{{ image('logos/logo-light.png') }}" class="h-40px app-sidebar-logo-default" />
        @elseif($bodyAttribute === 'light-sidebar')
				<img alt="Logo" src="{{ image('logos/logo.png') }}" class="theme-light-show h-40px app-sidebar-logo-default" />
				<img alt="Logo" src="{{ image('logos/logo-light.png') }}" class="theme-dark-show h-40px app-sidebar-logo-default" />
		@endif

		<img alt="Logo" src="{{ image('logos/icon.png') }}" class="h-30px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
